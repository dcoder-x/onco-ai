...
export const HowItWorks = () => {
  return (
    <div className="container md:px-20 md:w-[86%] md:absolute md:left-[13%] md:mt-20  flex flex-col justify-center items-center m-auto">
      <div>
        OncoAI FAQs What is OncoAI? OncoAI is your AI health assistant. It has a
        conversational interface, contextual awareness and personalization to
        ...
        ________________________________________ How does OncoAI work? You can
        ask OncoAI questions in natural, everyday language. To give you the most
        ...
        ________________________________________ What should I use OncoAI for?
        ...
        ________________________________________ What is 3-question limit? Ask
        up to 3 medical questions or symptoms for free and sign up FREE to
        explore further with our basic AI models like GPT-3.5. Subscriber will
        have unlimited access to GPT-4. Features
        ________________________________________ Search How does OncoAI search
        work? Whenever you type a question into search bar, OncoAI in the back
        ...
        ________________________________________ Symptoms How does OncoAI
        symptoms work? Symptoms are the most obvious sign of illness. OncoAI
        ...
        ________________________________________ References What is References
        and how to use it? Whenever you search OncoAI for an answer, OncoAI
        ...
        all the time. ________________________________________ Navigator What is
        Navigator and how is it different from Q & A? • Navigator is under
        ...
        ________________________________________ Threads What are Threads? A
        Thread refers to a full back-and-forth conversation with OncoAI. It
        ...
        ________________________________________ Popular now What is Popular
        Now? Popular Now gives you the global thread of what other OncoAI users
        are finding interesting. Whichever search that is frequently searched
        will go to the top of the list. ________________________________________
        AI Profile Why use an AI Profile? AI Profile is where you capture all of
        your unique preferences for gathering information so the AI can remember
        ...
        ________________________________________ Data Privacy & Security What
        data does OncoAI collect about me? We may collect IP addresses, device
        ...
        ________________________________________ Subscription How can I start a
        subscription? Click on Subscribe under bottom menu. Choose a
        ...
        ________________________________________ Contact How do I contact Team
        OncoAI? You can just email us at support@oncoai.com
      </div>
      <Outlet />
    </div>
  );
